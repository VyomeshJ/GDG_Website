    ...
    <div className="fixed inset-0 z-[300] bg-black/50 flex items-center justify-center px-4">
      ...
      <div className="relative bg-[#2C2C2C] rounded-xl p-6 
        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-10 mb-8">
          ...
          {/* New Member */}
          <div className="relative bg-[#5B7546]/70 
              w-full md:w-1/2 aspect-[3/4] rounded-xl overflow-hidden">
            ...
            <div className="absolute bottom-0 w-full h-2/3 bg-[#5B7546] rounded-t-xl shadow-[0_-6px_20px_rgba(0,0,0,0.3)]">
          ...
          <div className="relative bg-[#8A424F]/70 
            ...
            <div className="absolute top-0 w-full h-2/3 bg-[#8A424F] rounded-b-xl shadow-[0_6px_20px_rgba(0,0,0,0.3)]">
              <div className="relative w-full h-full p-6 md:p-12">
                <Image
