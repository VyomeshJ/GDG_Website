      ...
      >
        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-10 mb-8 overflow-y-auto flex-1 pr-2">
          ...
          <div className="relative bg-[#5B7546]/70 hover:bg-[#5B7546]/70
            ...
            <div className="absolute bottom-0 w-full h-2/3 bg-[#5B7546]/100 md:bg-[#5B7546]/0 group-hover:bg-[#5B7546]/100 rounded-xl shadow-[0_-6px_20px_rgba(0,0,0,0)] group-hover:shadow-[0_-6px_20px_rgba(0,0,0,0.3)]">
          ...
          <div className="relative bg-[#8A424F]/70 
            ...
            <div className="absolute top-0 w-full h-2/3 bg-[#8A424F]/100 md:bg-[#8A424F]/0 group-hover:bg-[#8A424F]/100 rounded-xl shadow-[0_-6px_20px_rgba(0,0,0,0)] group-hover:shadow-[0_-6px_20px_rgba(0,0,0,0.3)]">
              <div className="relative w-full h-full p-6 md:p-12">
                <Image
          ...
          <div className="relative bg-[#3d4770]/70 hover:bg-[#3d4770]/70
            ...
            <div className="absolute bottom-0 w-full h-2/3 bg-[#48558a]/100 md:bg-[#48558a]/0 group-hover:bg-[#48558a]/100 rounded-xl shadow-[0_-6px_20px_rgba(0,0,0,0)] group-hover:shadow-[0_-6px_20px_rgba(0,0,0,0.3)]">
              <div className="relative w-full h-full p-6 md:p-12">
                <Image
